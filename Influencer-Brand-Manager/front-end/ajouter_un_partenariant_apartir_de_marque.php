...
header('location: ../index.php');
    ...
    if ($result) {
        ...
        $sql1 = "DELETE FROM partenariant_from_influencer WHERE id_influenceur = $id_influenceur AND id_marque = $id_marque";
        $result = mysqli_query($conn, $sql1);
        header('location: demande_de_partenariats_from_influncer.php');
