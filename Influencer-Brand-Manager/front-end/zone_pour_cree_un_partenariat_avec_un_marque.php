...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO partenariant_from_influencer (id_marque, id_influenceur, montant, duree, date_experation)
            VALUES ('$brandid','$id','$montant', '$duree','$date_experation')";
...
<body>
    ...
    <div class="main-content">
        ...
        <h1>Remplire les information de contra avec <?= $brandnom ?></h1>
        ...
        <form action="" method="POST" style="margin-top: 80px;">
            ...
            <form action="" method="POST" class="login-email">
                ...
                <div class="input-group">
                    <label for="">la duree du contrat (en jours) : </label>
                    <input type="number" placeholder="la duree du contrat (en jour)" name="duree" value="" required>
                </div>
                <div class="input-group">
