...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <h2 class="dash-title">Les Nouveau message pour <?= $nom ?> <?= $prenom ?></h2>
                    ...
                    <div class="activity-card">
                        ...
                        <div class="table-responsive">
                            <table>
                                ...
                                <tbody>
                                    <?php $ret = mysqli_query($conn,"select * from message_de_marque where influencer_id = '$id'");
                                $cnt=1;
                                while($row = mysqli_fetch_array($ret))
                                {?>
                                <tr>
                                    <td><?php echo $cnt;?></td>
                                    <?php $id_source = $row['marque_id']?>
                                    

                                    <?php $ret_sr = mysqli_query($conn,"select * from marque where id ='$id_source'");?>
                                    <?php $row_sr = mysqli_fetch_array($ret_sr)?>
                                    <?php $brandnom = $row_sr['nom']?>
                                    ...
                                    <td style="font-size: 20px;">
                                        <?php echo '<h3><a href="zone_pour_envoie_message.php?brandid='.$id_source.'&&brandnom='.$brandnom.'">repondre</a></h3>';?>
                                    </td>
                                </tr>
                                <?php $cnt=$cnt+1; }?>
