...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <h2 class="dash-title">Profil de <?= $nom ?></h2>
                    ...
                    <form>
                        <table>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                <td><input class="form-control" type="text" value="<?= $logo?>" readonly></td>
                                </div>
                            </div>
                            </tr>
                            ...
                            <tr>
                            <div class="form-group row">
                            <td><label class="col-lg-3 col-form-label form-control-label">Chiffre Affaire</label></td>
                                <div class="col-lg-9">
                                <td><input class="form-control" type="number" value="<?= $chiffre_affaire?>" readonly></td>
                                </div>
                            </div>
                            </tr>
                            <tr>
