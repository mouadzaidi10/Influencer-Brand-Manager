                        ...
                        <div class="activity-card">
                            ...
                            <div class="table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        <?php $ret = mysqli_query($conn,"select * from partenariant_from_influencer where id_marque = '$id'");
                                    $cnt=1;
                                    while($row = mysqli_fetch_array($ret))
                                    {?>
                                    <tr>
                                        <td><?php echo $cnt;?></td>
                                        <?php $id_source = $row['id_influenceur']?>
                                        ...
                                        <td style="font-size: 10px;">
                                            ...
                                            <?php  echo '<h3><a href="ajouter_un_partenariant_apartir_de_marque.php?id_influenceur='.$id_source.'&&id_marque='.$id.'&&montant='.$montant.'&&duree='.$duree.'&&date_experation='.$date_experation.'">accepter</a></h3>' ;?>
                                            <?php  echo '<h3><a href="suprime_partenariant_apartir_de_marque.php?id_influenceur='.$id_source.'&&influencernom='.$influencernom.'&&id_marque='.$id.'">refusee</a></h3>';?>
                                        </td>
                                    </tr>
                                    <?php $cnt=$cnt+1; }?>
