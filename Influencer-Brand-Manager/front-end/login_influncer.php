...
<head>
	...
	<title>Login Form - Influncer</title>
</head>
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
			<p class="login-text" style="font-size: 2rem; font-weight: 800;">Authentification Influenceur</p>
			...
			<p class="login-register-text">Crée un compte? <a href="inscription_pour_influncer.php">Inscription Ici</a>.</p>
		</form>
