...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE influencer SET nom = '$new_nom', prenom = '$new_prenom', age = '$new_age', email = '$new_email', comptes_facebook = '$new_comptes_facebook', comptes_instagram = '$new_comptes_instagram' WHERE id = $id";
...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <h2 class="dash-title">Edite profil de <?= $nom ?> <?= $prenom ?></h2>
            ...
            <div class="tab-pane" id="edit">
                    <form method="POST">
                        <table>
                            ...
                            <tr>
                            <div class="form-group row">
                            <td><label class="col-lg-3 col-form-label form-control-label">Prenom</label>
                                <div class="col-lg-9">
                                <td><input class="form-control" type="text" name="prenom" value="<?= $prenom?>"></td>
                                </div>
                            </div>
                            </tr>
                            ...
                            <tr>
                            <div class="form-group row">
                            <td><label class="col-lg-3 col-form-label form-control-label">Age</label>
                                <div class="col-lg-9">
